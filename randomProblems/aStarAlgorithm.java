...
// 	                {
// 	                    if(inClosed(n1.getLocalName(), closed))                                      // If node in closed list, process next node
// 	                        continue;
// 	                    if(!inOpen(n1.getLocalName(), open))                                         // Check if not in open list
// 	                    {
	                      
// 	                        graph.setFx(n1,temp);                                               // Set fx for neighbour node via current
// 	                        open.add(graph.getHeadNode(n1.getLocalName()));                          // Add it toopen list
// 	                        parent.set(graph.getIndex(n1.getLocalName()), temp.getName());           // Set parent of neighbour node
// 	                    }
// 	                }
// 	                displayQueue(open);
// 	            }
